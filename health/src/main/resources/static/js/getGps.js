...
$('.side-button .location_btn button').click(function(){
...
// gps가 이용가능한지 체크하는 함수. 이용가능하다면 show location 함수를 불러온다.
// 작동되지 않으면 경고창을 띄우고, 에러가 있다면 errorHandler 함수를 불러온다.
...
function gps_tracking(){
	if (gps_use) {
        ...
        var gps_content = '<div class="gps"><img class="pulse" draggable="false" unselectable="on" src="resources/static/img/gps.png" alt=""></div>';
